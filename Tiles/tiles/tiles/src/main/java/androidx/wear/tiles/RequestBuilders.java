...
public final class RequestBuilders {
    ...
    /**
     * Parameters passed to a {@link TileBuilders.Tile} Service when the
    ...
    public static final class TileRequest {
        ...
        /**
         * Gets the {@link DeviceParameters}
        ...
        /**
         * Gets the {@link State} that should be used when
         * building the tile.
         *
         * @since 1.0
         */
        ...
        /**
         * Gets the {@link DeviceParametersBuilders.DeviceParameters} object
        ...
        public DeviceParametersBuilders.DeviceParameters getDeviceParameters() {
            if (mImpl.hasDeviceConfiguration()) {
                return DeviceParametersBuilders.DeviceParameters.fromProto(
        ...
        /**
         * Gets the {@link StateBuilders.State} that should be used when
         * building the tile.
         *
         * @since 1.0
        ...
        public StateBuilders.State getState() {
            if (mImpl.hasCurrentState()) {
                return StateBuilders.State.fromProto(mImpl.getCurrentState());
            } else {
                return null;
            }
        }
        ...
        public static final class Builder {
            ...
            /**
             * Sets the {@link DeviceParameters}
             * object describing the device requesting the tile update. If not set, a default empty
             * instance is used.
             *
             * @since 1.0
            ...
            /**
             * Sets the {@link State} that should be used
            ...
            /**
             * Sets the {@link DeviceParametersBuilders.DeviceParameters}
             * describing the device requesting the tile update.
             *
             * @since 1.0
            ...
            /**
             * Sets the {@link StateBuilders.State} that should be used when
             * building the tile.
             *
             * @since 1.0
            ...
            @Deprecated
            @NonNull
            public Builder setState(@NonNull StateBuilders.State state) {
    ...
    public static final class ResourcesRequest {
         ...
         * resource version, passed in {@link TileBuilders.Tile}.
         *
         * @since 1.0
         */
        @NonNull
