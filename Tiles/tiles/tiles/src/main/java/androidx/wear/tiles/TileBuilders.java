...
public final class TileBuilders {
    ...
    public static final class Tile {
         ...
         * RequestBuilders.ResourcesRequest} if the system does not have a copy
        ...
        /**
         * Gets the {@link Timeline} containing the
        ...
        /**
         * Gets the {@link TimelineBuilders.Timeline} containing the layouts for
        ...
        public TimelineBuilders.Timeline getTimeline() {
            if (mImpl.hasTileTimeline()) {
                return TimelineBuilders.Timeline.fromProto(
        ...
        public static final class Builder {
             ...
             * string; it is only used to cache resources, and is passed in {@link
             * RequestBuilders.ResourcesRequest} if the system does not have a
            ...
            /**
             * Sets the {@link Timeline} containing the
             * layouts for the tiles to show in the carousel, along with their validity periods.
             *
             * @since 1.0
             */
            ...
            /**
             * Sets the {@link TimelineBuilders.Timeline} containing the layouts
